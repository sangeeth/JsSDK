...
public class DefaultExecProcessor implements Processor
{
    ...
    public void handle(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
    {
        try
        {
	        ...
	        if (req.getAttribute("scriptcompiled")==null) {
	        	buffer.append("$import(\"js.dwr.core\");\n"); //$NON-NLS-1$
	        }
            ...
            for (int i = 0; i < calls.getCallCount(); i++)
            {
                ...
                if (call.getThrowable() != null)
                {
                    ...
                    buffer.append("js.dwr.core.DWREngine._handleServerError('"); //$NON-NLS-1$
                ...
                else
                {
                    ...
                    buffer.append('\n');
                    buffer.append(prefix);
                    buffer.append("js.dwr.core.DWREngine._handleResponse('"); //$NON-NLS-1$
                    buffer.append(call.getId());
                    buffer.append("', "); //$NON-NLS-1$
                    buffer.append(ov.getAssignCode());
                    buffer.append(");\n"); //$NON-NLS-1$
